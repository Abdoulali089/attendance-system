...
@section('content')
    <div class="max-w-4xl mx-auto pb-12">
        ...
        <!-- Page Header -->
        <div class="mb-10">
            <h1 class="text-4xl font-black text-slate-900 tracking-tight">Nouvel Employé ✍️</h1>
            <p class="mt-2 text-lg text-slate-500 font-medium">Remplissez les informations pour créer un nouvel accès.</p>
        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div>
                                ...
                                <select id="type" name="type"
                                    class="w-full px-6 py-4 rounded-2xl bg-slate-50 border-2 border-slate-50 text-slate-900 font-bold focus:bg-white focus:border-indigo-500 focus:ring-4 focus:ring-indigo-50 transition-all appearance-none cursor-pointer">
                                    <option value="employee" {{ old('type') == 'employee' ? 'selected' : '' }}>Employé
                                    </option>
